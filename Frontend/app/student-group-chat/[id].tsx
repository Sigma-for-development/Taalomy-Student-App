...
import {
  View, Text, StyleSheet, StatusBar, ActivityIndicator, TouchableOpacity, FlatList, TextInput, KeyboardAvoidingView, Platform, Image,
} from 'react-native';
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtext}>Start discussing with your group!</Text>
          </View>
        }
      />
