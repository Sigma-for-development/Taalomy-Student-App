...
const StudentAllClassesScreen = () => {
    ...
    const loadClasses = async () => {
        try {
            const response = await api.get(API_CONFIG.ENDPOINTS.STUDENT_CLASSES);
    ...
    const handleClassPress = async (classId: number) => {
        // Update access time in background
        try {
            api.post(`${API_CONFIG.ENDPOINTS.STUDENT_CLASS_ACCESS}${classId}/access/`);
        } catch (error) {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>{t('all_classes')}</Text>
            </View>
                ...
                <View style={styles.classesList}>
                    {classes.length > 0 ? (
                            ...
                            >
                                ...
                                <View style={styles.cardContent}>
                                    ...
                                    <View style={styles.metaInfo}>
                                        ...
                                        <Text style={styles.metaText}>{t('all_classes_enrolled', { count: cls.enrolled_count || 0 })}</Text>
                                    </View>
                                </View>
                        ...
                        <View style={styles.emptyState}>
                            ...
                            <Text style={styles.emptyText}>{t('all_classes_empty')}</Text>
                        </View>
                    )}
                </View>
            </ScrollView>
...
export default StudentAllClassesScreen;
