...
const StudentAllGroupsScreen = () => {
    ...
    const loadGroups = async () => {
        try {
            const response = await api.get(API_CONFIG.ENDPOINTS.STUDENT_GROUPS);
    ...
    const handleGroupPress = async (groupId: number) => {
        ...
        try {
            api.post(`${API_CONFIG.ENDPOINTS.STUDENT_GROUP_ACCESS}${groupId}/access/`);
        } catch (error) {
            console.error('Error updating access time:', error);
        }

        // Navigate immediately - corrected route based on Classes fix
        router.push(`/student-group-chat/${groupId}`);
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>{t('all_groups')}</Text>
            </View>
                ...
                <View style={styles.groupsList}>
                    {groups.length > 0 ? (
                            ...
                            >
                                ...
                                <View style={styles.cardContent}>
                                    ...
                                    <View style={styles.metaInfo}>
                                        ...
                                        <Text style={styles.metaText}>{t('all_groups_enrolled', { count: group.enrolled_count || 0 })}</Text>
                                    </View>
                                </View>
                        ...
                        <View style={styles.emptyState}>
                            <Ionicons name="people-outline" size={48} color="#34495e" />
...
export default StudentAllGroupsScreen;
